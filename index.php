...
<html>
	...
	<title>Todor Tsekov &mdash; Project Portfolio Website</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="This webiste will give you an overview of my own finished projects to this date." />
	<meta name="keywords" content=" html5, css3, mobile first, responsive" />
	<meta name="author" content="Todor Tsekov" />
	...
	<nav class="fh5co-nav" role="navigation">
		<div class="container">
			<div class="top-menu">
				<div class="row">
					<div class="col-sm-2">
						<div id="fh5co-logo"><a href="index.html"><img src="./images/T-Logo.png" alt=""></a></div>
					</div>
					<div class="col-sm-10 text-right menu-1">
						<ul>
							<li class="active"><a href="index.html">Portfolio</a></li>
							<li><a href="single.html">Resume</a></li>
							<li><a href="single.html">About Me</a></li>
		...
		<div id="fh5co-intro">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 col-md-pull-2">
					<h2>Welcome! ... To my site. <span><em>My name is</em> <a href="http://freehtml5.co">Todor.</a></span></h2>
				</div>
			</div>
		</div>
		<aside id="fh5co-hero">
